...
(function (factory) {
    ...
    var defaults = {
        ...
        fontFamily: 'BlenderProMedium',
        fontSize: 10,            // font-size of a digit by pixels
        lang: 'da',              // language of caption
    ...
    var dictionary = {
        ...
        da:{days:'dage',   hours:'timer',  min:'minutter',  sec:'sekunder'}
    };
            ...
            if(!data.vals || method === 'reset') { // new clock
                ...
                var left = Math.round(data.height / 10),
                    ...
                    thtml = (data.displayCaptions ?
                        (data.displayHours
                            ? '<figure style="max-width:'+ maxWidth +'px">$1<figcaption>'+ dictionary[data.lang].hours +'</figcaption></figure>'+ dot2
                            : '') +
                        '<figure style="max-width:'+ maxWidth +'px">$1<figcaption>'+ dictionary[data.lang].min +'</figcaption></figure>'+ dot2 +
                        '<figure style="max-width:'+ maxWidth +'px">$1<figcaption>'+ dictionary[data.lang].sec +'</figcaption></figure>'
